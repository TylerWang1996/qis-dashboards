...
| 8. Presentation update | Clustered official matrix, signed strategy waterfall, visible glossary, capitalization, regression and visual checks | Verified locally: 114 tests, Ruff, locked sync, independent review, static notebook/HTML visuals, and performance targets pass. Commit and private-main delivery checkpoint follows in I.6. |
